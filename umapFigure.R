...
par(mar=rep(0,4))
outline = matrix(c(rep(c(1), times = 3), rep(2, times = 1), rep(3, times = 1), rep(4, times = 3), rep(5, times = 1),
                   rep(6, times = 1), rep(7, times = 3), rep(8, times = 1), rep(9, times = 1), rep(10, times = 3), rep(11, times = 1), rep(12, times = 1)), 
